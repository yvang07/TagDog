		...
		<div class="row-fluid show-grid">
		    <div class="span6" id="create_left">
				...
				<input name = "create" id="c_line1" placeholder="Name" type="text" />
				<input name = "create" id="c_line2" placeholder="Address" type="text" />
				<input name = "create" id="c_line3" placeholder="Phone"type="text" />
				<input name = "create" id="c_line4" placeholder="Item" type="text" /></br>
